...
public:
    RadarKalmanFilter() {
        ...
        std::cout << "\033[5;32m" << "RadarAnnotationKalmanFilter starting" << "\033[0m" << std::endl;
        ...
        std::cout << "\033[5;32m" << "RadarAnnotationKalmanFilter ending"<< "\033[0m" << std::endl;
    ...
    void filterMain(const std::unordered_map<int, VectorXd>& measurements) {
        ...
        std::cout << "\033[5;32m" << "filterMain starting" << "\033[0m" << std::endl;
        ...
        std::cout << "\033[5;32m" << "filterMain ending"  << "\033[0m" << std::endl;
